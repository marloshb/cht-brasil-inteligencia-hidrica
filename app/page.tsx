...
import { AgentCenterHub } from "./agent-center-hub";
  ...
  return (
    <div className="app-shell" style={{ "--module-accent": activeModule.accent } as React.CSSProperties}>
      ...
      <main className="main-content">
        ...
        <div className={moduleId === "m12" ? "" : "generic-hidden"}>
          <AgentCenterHub
            contextItem={contextItem}
            territory={territory}
            clockLabel={formatClock(clock)}
        ...
        <section className={`analytics-grid ${(moduleId === "m0" && contextItem !== "Visão nacional") || moduleId === "m1" || moduleId === "m2" || moduleId === "m3" || moduleId === "m4" || moduleId === "m5" || moduleId === "m6" || moduleId === "m7" || moduleId === "m8" || moduleId === "m9" || moduleId === "m10" || moduleId === "m11" || moduleId === "m12" ? "generic-hidden" : ""}`}>
        ...
        <section className={`panel cases-panel ${moduleId === "m0" || moduleId === "m1" || moduleId === "m2" || moduleId === "m3" || moduleId === "m4" || moduleId === "m5" || moduleId === "m6" || moduleId === "m7" || moduleId === "m8" || moduleId === "m9" || moduleId === "m10" || moduleId === "m11" || moduleId === "m12" ? "generic-hidden" : ""}`}>
        ...
        <section className={`module-blueprint panel ${moduleId === "m0" || moduleId === "m1" || moduleId === "m2" || moduleId === "m3" || moduleId === "m4" || moduleId === "m5" || moduleId === "m6" || moduleId === "m7" || moduleId === "m8" || moduleId === "m9" || moduleId === "m10" || moduleId === "m11" || moduleId === "m12" ? "generic-hidden" : ""}`}>
